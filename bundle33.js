...
// // src/components/mkacTabs/mkacTabs.js
// import * as styles from './mkacTabs.module.scss';

// export class mkacTabs {
...
//     render() {
//         this.container.classList.add(styles.tabContainer);
//         // Tạo div tabs
//         this.tabsContainer = document.createElement("div");
//         this.tabsContainer.classList.add(styles.tabs);
...
//         this.indicator.classList.add(styles.indicator);
...
//             const tabElement = event.target.closest(`.${styles.tab}`);
...
/* harmony default export */ const mkacTabs_mkacTabs = (mkacTabs);
